<template>
  <PatternSection>
    <BasicSection class="container mx-auto mt-20">
      <HeadlineOneHero>Amerus Financial Privacy Policy</HeadlineOneHero>
      ...
      with our website. What personal information do we collect from the people
      that visit our blog, website or app? When ordering or registering on our
      ...
      <HeadlineTwo>When do we collect information?</HeadlineTwo>
      We collect information from you when you register on our site, place an
      order, fill out a form or enter information on our site. How do we use
      your information? We may use the information we collect from you when you
      register, make a purchase, sign up for our newsletter, respond to a survey
      or marketing communication, surf the website, or use certain other site
      features in the following ways: To allow us to better service you in
      responding to your customer service requests. To quickly process your
      transactions.
      <HeadlineTwo>How do we protect your information?</HeadlineTwo>
      ...
      <HeadlineTwo>We use regular Malware Scanning.</HeadlineTwo>
      ...
      <HeadlineTwo>Do we use ‘cookies’?</HeadlineTwo>
      ...
      <HeadlineTwo>We use cookies to:</HeadlineTwo>
      Help remember and process the items in the shopping cart. Understand and
      save user’s preferences for future visits. Compile aggregate data about
      ...
      services that track this information on our behalf. You can choose to have
      your computer warn you each time a cookie is being sent, or you can choose
      ...
      function properly. It won’t affect the user’s experience that make your
      site experience more efficient and may not function properly.

      <HeadlineTwo>Third-party disclosure</HeadlineTwo>
      We do not sell, trade, or otherwise transfer to outside parties your
      Personally Identifiable Information.

      <HeadlineTwo>Third-party links</HeadlineTwo>
      ...
      <HeadlineTwo>Google</HeadlineTwo>
      ...
      use Google AdSense Advertising on our website. Google, as a third-party
      ...
      our site and other sites on the Internet. Users may opt-out of the use of
      the DART cookie by visiting the Google Ad and Content Network privacy
      policy.

      <HeadlineTwo>We have implemented the following:</HeadlineTwo>
      ...
      <HeadlineTwo>Opting out:</HeadlineTwo>
      ...
      Analytics opt out Browser add on. California Online Privacy Protection
      ActCalOPPA is the first state law in the nation to require commercial
      ...
      http://consumercal.org/california-online-privacy-protection-act-caloppa/#sthash.0FdRbT51.dpufAccording
      to CalOPPA, we agree to the following:

      <HeadlineTwo>Users can visit our site anonymously.</HeadlineTwo>
      ...
      easily be found on the page specified above. You will be notified of any
      Privacy Policy changes: On our Privacy Policy Page
      <HeadlineTwo>Can change your personal information:</HeadlineTwo>
      By emailing us By calling us By logging in to your account
      <HeadlineTwo>How does our site handle Do Not Track signals?</HeadlineTwo>
      We honor Do Not Track signals and Do Not Track, plant cookies, or use
      advertising when a Do Not Track (DNT) browser mechanism is in place.

      <HeadlineTwo
        >Does our site allow third-party behavioral tracking?</HeadlineTwo
      >
      It’s also important to note that we do not allow third-party behavioral
      tracking COPPA (Children Online Privacy Protection Act)When it comes to
      the collection of personal information from children under the age of 13
      ...
      privacy and safety online. We do not specifically market to children under
      the age of 13 years old.

      <HeadlineTwo>Fair Information Practices</HeadlineTwo>
      ...
      that protect personal information. In order to be in line with Fair
      Information Practices we will take the following responsive action, should
      a data breach occur:

      <HeadlineTwo>We will notify you via email</HeadlineTwo>
      Within 1 business day
      <HeadlineTwo>We will notify you via letter</HeadlineTwo>
      Within 7 business days We also agree to the Individual Redress Principle
      ...
      <HeadlineTwo
        ...
        following:</HeadlineTwo
      >
      Not use false or misleading subjects or email addresses. Identify the
      message as an advertisement in some reasonable way. Include the physical
      address of our business or site headquarters. Monitor third-party email
      marketing services for compliance, if one is used. Honor
      opt-out/unsubscribe requests quickly. Allow users to unsubscribe by using
      the link at the bottom of each email. If at any time you would like to
      unsubscribe from receiving future emails, you can email us a Follow the
      instructions at the bottom of each email. and we will promptly remove you
      from ALL correspondence.

      <HeadlineTwo>Contacting Us</HeadlineTwo>
      If there are any questions regarding this privacy policy, you may contact
      us using the information below. http://www.amerusfinancial.com
      <pre>
215 Imperial Blvd Suite A1
...
United States
      ...
      >
      support@AmerusFinancial.com(888) 441-7891
