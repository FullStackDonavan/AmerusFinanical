<template>
  <PatternSection>
    <BasicSection>
      <HealthInsuranceServicesHeroSection />
      <Breadcrumbs
        currentPageTitle="Health Insurance"
        parentTitle="Individual Health Insurance"
        parentUrl="/individual-health-insurance/"
      />
      <HealthcareQuoteSection />
      <AboutAmerusFinancialGroupSolutionsSection />
      <MarketplaceHealthInsuranceSection />
      <MarketplaceProsAndCons />

      <ShortTermHealthInsuranceSection />
      <ShortTermHealthInsuranceProsAndConsSection />

      <IndemnitySection />
      <IndemnityProsAndCons />

      <HealthcareFrequentlyAskedQuestions
        :items="[
          {
          ...
          {
            title: 'Am I eligible for a subsidy?',
            content:
          ...
          {
            title: 'Will a Short Term Insurance plan cover my Pregnancy?',
            content:
